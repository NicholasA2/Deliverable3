...
public class FullTimeTeacher extends Teacher implements PayRoll{
    ...
    public FullTimeTeacher(String specialty, String degree, double salary, double degreeRate, int hoursWorked, String fname, String lname, int age, String gender, String status) {
